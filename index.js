...
const manifest = {
  ...
  logo: "https://i.imgur.com/9z4ZQ0T.png", // addon icon
  types: ["tv"],
  ...
  catalogs: [
    {
      ...
      extra: [
        {
          name: "m3uUrl",          // key passed to handlers
          isRequired: true,        // must be filled
          isUserVisible: true,     // shows in UI
  ...
  behaviorHints: {
    configurationRequired: true  // forces gear icon
  }
};
